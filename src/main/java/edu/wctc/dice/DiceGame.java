...
import edu.wctc.dice.impl.SingleNonDynamicRoller;
...
public class DiceGame
{
    ...
    /*@Autowired
    public DiceGame(GameInput in, GameOutput out, DiceRoller dieRoller, Dice die)*/
    @Autowired
    public DiceGame(GameInput in, GameOutput out, Dice die)
    {
        this.in = in;
        this.out = out;
...
//        logger.info("Game end");
    ...
    {
        int die1 = die.rollDice();
        int die2 = die.rollDice();
